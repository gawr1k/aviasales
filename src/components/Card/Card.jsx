...
export default function Card({
  price, img, origin, destination,
  backorigin, backdestination, date, backdate,
  duration, backduration, stops, backstops,
}) {
    ...
    <div className="content__card">
      <div className="content__card__container">
        <div className="content__card__container__header-card">
          ...
          <img className="content__card__container__header-card__airlanes" src={img ? `${baseUrl}${img}.png` : null} alt="airlanes-logotype" />
        </div>
        <div className="content__card__container__info">
          <div className="content__card__container__info__route">
            <h5>{`${origin} – ${destination}`}</h5>
            <h4>{`${formatTime(date)} - ${calculateEndTime(date, duration)}`}</h4>
          </div>
          <div className="content__card__container__info__route">
            <h5>В пути</h5>
        ...
        <div className="content__card__container__info">
          <div className="content__card__container__info__route">
            ...
            <h4>{`${formatTime(backdate)} - ${calculateEndTime(backdate, backduration)}`}</h4>
          </div>
          <div className="content__card__container__info__route">
            <h5>В пути</h5>
